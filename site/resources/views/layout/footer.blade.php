    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <p class="footer-text"><i class="fas fa-map-marker-alt"></i> ফার্মগেট, ঢাকা </p>
                <p class="footer-text"><i class="fas fa-phone"></i> ০১৭৯৪৯১৪৫৭০ </p>
                <p class="footer-text"><i class="fas fa-envelope"></i> mishu.cse616@gmail.com</p>
            </div>
            <div class="col-md-3 col-lg-3 col-sm-6">
            ...
            <div class="col-md-3 col-lg-3 col-sm-6">
                ...
                <hr>
                <a class="footer-link" target="_blank" href="{{url('/privacy')}}">গোপনীয়তা নীতি</a><br>
...
<div class="container-fluid bg-dark text-white m-0 text-center p-3">
    <p class="rights-text  my-2 ">সর্বস্বত্ব মিশু রহমান দ্বারা সংরক্ষিত; ২০২২-২০২৩ </p>
</div>